...
type = ['orphanage', 'faggot house', 'hospital', 'bank', 'supermarket', 'hardware store', 'school', 'shooting', 'kindergarden', 'goverment', 'non-profit']
method = ['malware',
          'DoS Attack',
          'DDoS Attack',
          'Phishing',
...
with open('trust-database.csv', 'w') as file:
